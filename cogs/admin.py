...
moderation_group= app_commands.Group(name='moderation',  description='Moderation')


# ── /admin general ────────────────────────────────────────────────────────────

@general_group.command(name='unflood', description='Löscht eine bestimmte Anzahl Nachrichten im aktuellen Channel')
...
@moderation_group.command(name='timeout', description='Gibt einem Nutzer einen Timeout')
...
@moderation_group.command(name='kick', description='Kickt einen Nutzer vom Server')
...
async def setup(bot):
    ...
    admin_group.add_command(moderation_group)
